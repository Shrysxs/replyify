...
export function Chip({ label, selected, onClick, className, ...rest }: ChipProps) {
  return (
    <button
      ...
      className={[
        "group inline-flex items-center select-none text-sm font-medium will-change-transform text-responsive",
        "rounded-full px-4 sm:px-5 py-2 sm:py-2.5 transition-all duration-200 border backdrop-blur-sm touch-manipulation",
        selected
    ...
    >
      <span className="relative font-medium text-responsive truncate">
        {label}
        <span className={[
