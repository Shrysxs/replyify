      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <h3 className="text-2xl font-bold text-neutral-200 retro uppercase tracking-widest">
              Replyify
            </h3>
          </div>
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="group flex items-center gap-2 text-neutral-400 hover:text-green-400 transition-colors duration-300"
            >
        ...
        >
          <p className="text-xs text-neutral-600 uppercase tracking-wide">
            © 2024 Replyify. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
